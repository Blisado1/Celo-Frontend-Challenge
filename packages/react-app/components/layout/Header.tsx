...
import TransactionHistory from "../modal/TransactionHistoryModal";

export default function Header() {
  return (
    <Disclosure as="nav" className="bg-blue-500 border-b border-black">
      {({ open }) => (
        <>
              ...
              <div className="flex flex-1 items-center justify-center sm:items-stretch sm:justify-start">
                ...
                <div className="hidden sm:ml-6 sm:flex sm:space-x-8">
                  <a
                    ...
                    <span className="px-6 py-2.5 hover:bg-white-900 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out">Home</span>
                  </a>
                  <div
                    className="inline-flex items-center border-b-2 border-black px-1 pt-1 text-sm font-medium text-gray-900">
                      <TransactionHistory />
