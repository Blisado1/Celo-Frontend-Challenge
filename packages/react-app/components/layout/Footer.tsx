...
const navigation = [
  {
    name: "Dacade",
    href: "https://dacade.org/communities/celo/challenges/c603480f-b346-4397-aa52-95826fa0ce6d",
    icon: (props: Props) => (
      <svg
        version="1.0"
...
46 -11 37 11 -5 36 -29 55 -53z"
  ...
  {
    name: "GitHub",
    href: "https://github.com/Blisado1/Celo-Frontend-Challenge",
    icon: (props: Props) => (
...
export default function Footer() {
  return (
    <footer className="bg-blue-500 mt-auto border-black border-t">
      <div className="mx-auto max-w-7xl py-6 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
        ...
        <div className="mt-8 md:order-1 md:mt-0">
          ...
          Designed for DACADE &copy;   {new Date().getFullYear()}
          </p>
        </div>
      </div>
    </footer>
