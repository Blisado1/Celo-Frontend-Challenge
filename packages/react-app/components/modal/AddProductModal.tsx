    ...
    <div className={"flex flex-row w-full justify-between"}>
      <div>
        ...
        <button
          ...
          className="inline-block px-6 py-2.5 bg-gray-500 text-black font-medium text-md leading-tight hover:bg-gray-700 hover:shadow-lg focus:bg-gray-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-gray-800 active:shadow-lg transition duration-150 ease-in-out"
              ...
              <div className="flex items-center justify-center min-height-100vh pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                ...
                <div
                  ...
                  <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    ...
                    <label>Product Price (cREAL)</label>
                    <input
                      onChange={(e) => {
